...
### Added
- **Clean Slug URLs & Top-Level Shortcut Routes (`/app/<slug>`, `/backoffice/cms`, `/backoffice/onboarding`, `/backoffice/payments`)**: Eliminated long, deep 24-character hexadecimal MongoDB ObjectIDs and nested URL slashes. Backoffice routes now resolve human-readable client slugs (e.g., `/backoffice/app/ministry_exam_prep`) as well as active session shortcuts (`/backoffice/cms`, `/backoffice/onboarding`, `/backoffice/payments`).
